      ...
      <section v-if="cargadoNoticias" class="noticia m-0 mt-3 row w-100">
        <article class="col-12 col-sm-6 col-lg-4 py-3 px-0 px-sm-2 d-flex flex-column" data-aos="zoom-in"
          ...
          <router-link :to="{ name: 'Noticia', query: { id: item.id }}" class="linkNonStyle">
            <img class="img-fluid imgNoticias" :src="'https://moha.ulandu.com/uploads/noticias/'+item.imagen">
          </router-link>
      ...
      <section class="modelos row mt-3 mx-0 w-100">
        <article data-aos="flip-right" class="col-12 col-md-6 py-3 px-0 px-md-2">
          <router-link :to="{ name: 'Modelo', query: { id: '1' }}" class="linkNonStyle">
            <div class="modelo centarPalabras" style="background-image: url('https://moha.ulandu.com/uploads/imgStatic/s1000rrHomeModelos.jpg')">
        ...
        <article data-aos="flip-left" class="col-12 col-md-6 py-3 px-0 px-md-2">
          <router-link :to="{ name: 'Modelo', query: { id: '3' }}" class="linkNonStyle">
            <div class="modelo centarPalabras" style="background-image: url('https://moha.ulandu.com/uploads/imgStatic/mt-09HomeModelos.jpg')">
      ...
      <section class="findUsContainer mx-0 mt-3 row w-100">
        <div class="col-12 col-md-6 row p-0 m-0">
          <a href="https://www.instagram.com/p/CeO_52mqIrN/" class="col-6 p-0" target="_blank">
            <div class="imgInsta" style="background-image: url('https://moha.ulandu.com/uploads/imgStatic/mt-09HomeModelos.jpg')"></div>
          </a>
          <a href="https://www.instagram.com/p/CePQgskqX7V/" class="col-6 p-0" target="_blank">
            <div class="imgInsta" style="background-image: url('https://moha.ulandu.com/uploads/imgStatic/s1000rrHome.jpg')"></div>
          </a>
          <a href="https://www.instagram.com/p/CeO_nG8qDiG/" class="col-6 p-0" target="_blank">
            <div class="imgInsta" style="background-image: url('https://moha.ulandu.com/uploads/imgStatic/R1MHome.jpg')"></div>
          </a>
          <a href="https://www.instagram.com/p/CePQUUBqptL/" class="col-6 p-0" target="_blank">
            <div class="imgInsta" style="background-image: url('https://moha.ulandu.com/uploads/imgStatic/multistrada2.jpg')"></div>
          </a>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      async sendEmail() {
        ...
        await fetch('https://moha.ulandu.com/api/sendEmail', {
          method: 'POST',
