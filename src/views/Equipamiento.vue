<template>
  <div class="equipamientoContainer">
...
export default {
  ...
  methods:{
    async getEquipamiento() {
      let response=await fetch('http://localhost:8000/api/equipamiento/' + this.$route.params.id, {
...
.containerSlider:hover .prev, .containerSlider:hover .next{
  opacity: 1;
}
