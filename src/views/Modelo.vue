    ...
    <div v-if="cargado" class="modelo">
      ...
      <div class="containerImgPrice">
        <video v-if="this.dataModel.nombreEs==='BMW S 1000 RR 2021'" id="video1" loop autoplay muted="muted">
          <source
              :src="'https://proyectogradoback.herokuapp.com/uploads/modelos/'+this.dataModel.nombreEs+'/'+this.dataModel.nombreEs+'Portada.mp4'"
              type="video/mp4">
        </video>
        <picture v-else class="w-100">
          <img class="img-fluid w-100"
               :src="'https://proyectogradoback.herokuapp.com/uploads/modelos/'+this.dataModel.nombreEs+'/'+this.dataModel.nombreEs+'Portada.jpg'">
        </picture>
      ...
      <div class="text-dark text-left w-80 textPreview">
        ...
        <div>
          ...
          <div class="my-5">
            <div class="containerImgMotor">
              <img style="width: 100%;"
                   :src="'https://proyectogradoback.herokuapp.com/uploads/modelos/'+this.dataModel.nombreEs+'/'+this.dataModel.nombreEs+'-1.jpg'">
              <div class="motorContainer">
                <div class="d-flex">
                  <div class="motorLeft">
                    <div>
                      <div class="letraMotor">
                        {{ this.dataModel.cv }}
                      </div>
                      <div>
                        {{$t('88')}}
                  ...
                  <div class="motorCenter">
                    <svg version="1.1" class="animatedfacts__circleLeft" xmlns="http://www.w3.org/2000/svg" x="0px"
                         y="0px"
                    ...
                    <div>
                      <img class="img-fluid"
                           :src="'https://proyectogradoback.herokuapp.com/uploads/modelos/'+this.dataModel.nombreEs+'/'+this.dataModel.nombreEs+'Motor.jpg'">
                    </div>
        ...
        <div class="sonidoMotor">
          <div class="sonidoPotente">
          ...
          <div class="position-relative d-flex justify-content-end w-100">
            <img style="width: 100%;"
                 :src="'https://proyectogradoback.herokuapp.com/uploads/modelos/'+this.dataModel.nombreEs+'/'+this.dataModel.nombreEs+'-2.jpg'">
...
.motorCenter svg line {
  fill: none;
  stroke: rgba(22, 23, 26, 0.5);
