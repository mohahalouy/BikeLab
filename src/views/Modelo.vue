<template>
  <div class="modelos">
    ...
    <div v-if="cargado" class="modelo">
      <div>
        ...
        <div class="precioModelo">
          ...
          <button class="btnAniadir">Añadir a la cesta</button>
        </div>
    ...
    <audio style="display: none" id="sonidoMotor" :src="'http://127.0.0.1:8000/uploads/modelos/sonidoMotor/'+this.dataModel.sonidoMotor" controls></audio>
  </div>
</template>
